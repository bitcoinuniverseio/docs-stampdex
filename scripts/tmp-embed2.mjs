...
insertAfterHeading('src/content/docs/reference/order-states.mdx', '## The states', '<OrderStateExplorer />');
addImportAfterFm('src/content/docs/reference/fees.mdx', "import FeeExplorer from '../../../components/explainers/FeeExplorer.astro';");
insertAfterHeading('src/content/docs/reference/fees.mdx', '## SRC-20 marketplace trades', '<FeeExplorer />');
...
insertAfterHeading('src/content/docs/reference/wallets.mdx', '## What each wallet can do here', '<WalletExplorer />');
addImportAfterFm('src/content/docs/guides/psbt-review.mdx', "import TxAnatomy from '../../../components/explainers/TxAnatomy.astro';");
insertAfterHeading('src/content/docs/guides/psbt-review.mdx', '## What to check on a buy', '<TxAnatomy />');
